var DenialState = {
    ...
    create: function () {
        ...
        room = game.add.sprite(canvasX, canvasY, 'room');
        room.anchor.setTo(0.5, 0.5);
        room.angle = 90;
        room.scale.setTo(1.2);
        ...
        fan = game.add.sprite(canvasX, canvasY, 'something');

        fan.angle = 90;
        fanSS = fan.animations.add('fanSpinning');
        fan.animations.play('fanSpinning', 30, true);
        fan.anchor.setTo(0.5, 0.5);

        video = game.add.video('inBed');
        sprite = video.addToWorld(clickableSquare.position.x, clickableSquare.position.y, 0.5, 0.5);
        sprite.angle = 90;
        ...
        clickableSquare.width = 300;
        clickableSquare.height = 300;
        ...
        this.movingPOV(room);
        this.movingPOV(fan);
        this.movingPOV(clickableSquare);
        this.movingPOV(sprite);
    ...
    update: function () {
        if (this.checkOverlap(hand, clickableSquare)) {
